...
//        Admin admin = new Admin(1001, "Admin", "admin@example.com", "admin123");
//        List<Product> products = new ArrayList<>(); // 商品列表
//        int productId = 0; // 商品ID，默认值为-1
//
//        while (true) {
...
//                        Product newProduct = new Product(productId, productName, productPrice, stockQuantity);
//                        admin.addProduct(newProduct);
//                        products.add(newProduct); // 将新商品添加到商品列表
//                    } else {
